...
export async function listHelpers(
  ...
  const allHelpers = [
    ...
    },
    {
      ...
      syntax:
        '{{#switch value}}{{#case "x"}}...{{/case}}{{#default}}...{{/default}}{{/switch}}',
      example: includeExamples
    ...
    },
    {
      ...
      syntax:
        '{{#eachUnique items}}...{{/eachUnique}} or {{#eachUnique items "id"}}...{{/eachUnique}}',
      example: includeExamples
    ...
    },
    {
      ...
      category: 'iteration',
      description:
        'Groups items in an array by a specified property (supports nested properties with dot notation)',
      syntax:
        '{{#group items by="property"}}{{value}} - {{#each items}}...{{/each}}{{/group}}',
      example: includeExamples
  ...
  const categories = Array.from(
    new Set(filteredHelpers.map((h) => h.category))
  ).sort();
    ...
    context_variables: [
      {
        name: 'clay_model',
        description:
          'Complete root model - accessible from any template context for lookups and cross-references',
 ...
 */
export async function listHelpersTool(args: unknown) {
