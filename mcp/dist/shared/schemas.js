...
export const WorkingDirectorySchema = z
    .string()
    .optional()
    .describe('Directory containing .clay file (defaults to current working directory)');
...
export const OutputPathSchema = z
    .string()
    .describe('Output directory for generated files (relative to working directory)');
// ============================================================================
...
export const InitInputSchema = z
    ...
    type: z
        ...
        .default('project')
        .describe('What to initialize: project creates .clay file, generator creates generator structure'),
    name: z
        .string()
        .optional()
...
export const ListHelpersInputSchema = z
    ...
    category: z
        ...
        .optional()
        .describe('Filter helpers by category (optional - returns all if not specified)'),
    include_examples: z
        .boolean()
        .default(false)
...
export const ListHelpersOutputSchema = z.object({
    ...
    context_variables: z.array(z.object({
        name: z.string(),
        description: z.string(),
        example: z.string(),
    })),
