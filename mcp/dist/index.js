        ...
        this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
            tools: [
                ...
                },
                {
                    ...
                    description: 'List all available Handlebars helpers for Clay templates. Helps when creating or modifying templates by showing available helpers, their syntax, and usage examples.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            category: {
                                ...
                                description: 'Filter helpers by category (optional - returns all if not specified)',
                            },
                            include_examples: {
                                type: 'boolean',
                                default: false,
                ...
                },
                {
                    ...
                    description: 'Get comprehensive Clay documentation explaining how to create models, generators, and templates. Essential for understanding Clay capabilities including hidden features like clay_key, clay_parent, and other template context variables.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            topic: {
                                ...
                                description: 'Specific topic to explain: overview (Clay basics), models (creating models), generators (creating generators), templates (writing templates), context-variables (clay_key, clay_parent, etc.), jsonpath (selectors), mixins (model transformations), or all (everything)',
                            },
                            include_examples: {
                                type: 'boolean',
                                default: true,
